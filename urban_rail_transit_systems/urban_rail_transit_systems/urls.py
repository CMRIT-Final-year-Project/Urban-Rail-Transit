...
from urban_rail_transit_systems import settings
...
urlpatterns = [
    ...
    url(r'^Search_Rails_DataSets/$', remoteuser.Search_Rails_DataSets, name="Search_Rails_DataSets"),
    ...
    url(r'^Find_Impact_Ratio_Delay/$', serviceprovider.Find_Impact_Ratio_Delay, name="Find_Impact_Ratio_Delay"),
    url(r'^View_Impact_Prediction_Details/$', serviceprovider.View_Impact_Prediction_Details, name="View_Impact_Prediction_Details"),
    url(r'^Train_View_Rail_DataSets_Details/$', serviceprovider.Train_View_Rail_DataSets_Details, name="Train_View_Rail_DataSets_Details"),
